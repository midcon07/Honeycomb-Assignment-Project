...
- **TOMORROW (parked 2026-09-07 23:50, Mark: "Save this for tomorrow"):**
  ...
  2. **AI traffic** - `notes/traffic-plan.md`, "Next" list: the container diff is DONE (negative); what remains is the mode choice (BATC / FSLTL / MSFS) in the launcher and the preflight rows per mode.
