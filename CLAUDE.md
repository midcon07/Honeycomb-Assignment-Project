...
- **Security audit 2026-09-05 → `notes/security-audit-2026-09-05.md`**, ten items as a checklist. **1 and 2 done 2026-09-10** (`tools/FsuipcIni.ps1`, below). Do 4 (Google Fonts fetched on every start) before anyone outside Mark and midcon07 runs it.
